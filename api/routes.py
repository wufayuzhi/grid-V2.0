...
def _state_dict(st):
    ...
    for k in (
        ...
        "total_equity", "reserved_capital", "total_pnl", "total_fee", "grid_count", "rebalance_cnt",
    ...
    d["params"] = {
        ...
        "ladder_gap_up": list(getattr(st, "ladder_gap_up", [2.0, 1.5, 1.2, 1.0, 0.8])),
        "ladder_gap_dn": list(getattr(st, "ladder_gap_dn", [1.0, 0.8, 0.7, 0.5, 0.4])),
...
def register_routes(app: FastAPI):
    ...
    async def set_params(req: dict):
        ...
        for k in ["capital", "reserved_capital", "leverage", "imbalance_threshold",
                  ...
                  "iceberg_sz", "pxVar", "grid_auto_run", "use_iceberg",
                  "use_risk_control", "use_bleed_melt",
                  ...
                  "base_density", "defense_density", "mode",
